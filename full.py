...
def pretty(list):
    ...
    for elem in list:
        if("Erreur de date" in elem.name):
            ...
            newList.append(elem.name + " : " + elem.propositions[2].name + " et " + elem.propositions[3].name + " se sont rencontrés à " + elem.propositions[1].name + " et en un autre lieu en même temps à la date " + elem.propositions[0].name)
    return newList
